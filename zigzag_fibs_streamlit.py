...
if data is not None:
    ...
    window_width = st.slider('Window Width', min_value=100, max_value=len(data) if len(data) > 100 else 100, value=100, key='window_width_1') # Adjusted max_value for window_width
